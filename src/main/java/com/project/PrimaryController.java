...
public class PrimaryController {
    ...
    private DoubleProperty nb_acc = new SimpleDoubleProperty();
    ...
    private void initialize() {
        ...
        nb_ac.textProperty().bind(nb_acc.asString());
    ...
    private void loadCSVdata(File data) throws IOException {
        ...
        String scriptPath = "D:\\Working Folder\\Desktop\\Kaggle\\Project-1\\project\\src\\main\\java\\com\\project\\cls.py";
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                else if("nb".equalsIgnoreCase(line)){
                    line = reader.readLine();
                    nb_acc.set(Double.valueOf(line.trim()));
                }
